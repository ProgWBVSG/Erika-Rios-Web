                    ...
                    >
                        ...
                        <div className="space-y-6 mt-12">
                            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <a href="https://wa.me/5493572440360?text=Hola%20Erika!%20Me%20gustar%C3%ADa%20saber%20la%20pr%C3%B3xima%20fecha%20de%20Camino%20Abierto%20(Trekking)." target="_blank" rel="noopener noreferrer" className="text-brand-olive-900 font-medium flex items-center gap-2 text-sm group hover:text-brand-taupe-dark transition-colors">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <a href="https://wa.me/5493572440360?text=Hola%20Erika!%20Quiero%20m%C3%A1s%20info%20sobre%20la%20tertulia%20El%20Arte%20de%20Envejecer." target="_blank" rel="noopener noreferrer" className="text-brand-olive-900 font-medium flex items-center gap-2 text-sm group hover:text-brand-taupe-dark transition-colors">
                                    Saber más <MoveRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                                </a>
                            </div>
                        </div>
