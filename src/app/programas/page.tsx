        ...
        <div className="bg-stone-50 min-h-screen pt-32 pb-24">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="bg-white rounded-[2rem] p-8 md:p-16 shadow-xl border border-stone-100 mb-16 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-1/2 h-full bg-amber-500/5 -skew-x-12 translate-x-32 hidden md:block"></div>

                    <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
                        <div>
                            <span className="text-amber-600 font-bold uppercase tracking-widest text-sm mb-4 block">Programa Estrella</span>
                            <h2 className="text-3xl md:text-5xl font-bold text-stone-900 mb-6 font-serif">Aprender a Aprender</h2>
                            ...
                            <ul className="space-y-4 mb-10 text-stone-700">
                                <li className="flex items-start gap-3">
                                    <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center shrink-0 mt-1"><Sparkles className="w-3 h-3 text-amber-600" /></div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="https://wa.me/5493572440360?text=Hola%20Erika!%20Quiero%20saber%20m%C3%A1s%20e%20inscribirme%20al%20programa%20Aprender%20a%20Aprender." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-stone-900 text-white px-8 py-4 rounded-full font-medium hover:bg-stone-800 transition-colors shadow-xl">
                                    Quiero inscribirme
                        ...
                        <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            <Image
                                src="/images/placeholder_aprender.jpg"
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="relative h-[400px] md:h-full min-h-[500px] rounded-[2rem] overflow-hidden shadow-2xl order-last md:order-first">
                        ...
                        <Image
                            src="/images/placeholder_identidad.jpg"
                    ...
                    <div className="bg-white p-10 md:p-14 rounded-[2rem] shadow-sm border border-stone-100">
                        <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6 font-serif">Diseña tu Identidad</h2>
                        <p className="text-stone-600 text-lg mb-8 leading-relaxed">
                        ...
                        <div className="space-y-6 mb-10">
                            <div className="flex gap-4 p-4 rounded-xl bg-stone-50 border border-stone-100">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">Mapeo de la Vieja Identidad</h4>
                            ...
                            <div className="flex gap-4 p-4 rounded-xl bg-stone-50 border border-stone-100">
                                ...
                                <div>
                                    <h4 className="font-bold text-stone-900">Construcción de Futuro</h4>
                                    <p className="text-sm text-stone-600 mt-1">Generar acciones consistentes con el ser audaz que declaramos ser.</p>
                                </div>
                            </div>
                        </div>

                        <a href="https://wa.me/5493572440360?text=Hola%20Erika!%20Me%20interesa%20sumarme%20al%20desaf%C3%ADo%20Dise%C3%B1a%20tu%20Identidad." target="_blank" rel="noopener noreferrer" className="inline-flex w-full items-center justify-center gap-2 bg-amber-600 text-white px-8 py-4 rounded-full font-medium hover:bg-amber-500 transition-colors shadow-lg">
                            Sumate al desafío
                        </a>
                    </div>
                </div>
