...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900 font-sans selection:bg-amber-200 selection:text-amber-900">

      {/* Navigation */}
      <nav className="fixed w-full z-50 top-0 border-b border-stone-200/50 bg-stone-50/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <span className="text-xl font-bold tracking-tighter text-stone-800">ERIKA RÍOS</span>
          <div className="hidden md:flex gap-8 text-sm font-medium text-stone-600">
            <a href="#sobre-mi" className="hover:text-amber-700 transition-colors">Sobre mí</a>
            <a href="#servicios" className="hover:text-amber-700 transition-colors">Servicios</a>
            <a href="#contacto" className="hover:text-amber-700 transition-colors">Contacto</a>
          </div>
          <a href="#contacto" className="bg-stone-900 text-stone-50 px-5 py-2.5 rounded-full text-sm font-medium hover:bg-stone-800 transition-colors">
            Agendar Sesión
          </a>
        </div>
      </nav>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden flex items-center min-h-[90vh]">
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter leading-[1.05] mb-6 text-stone-800">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contacto" className="flex items-center justify-center gap-2 bg-stone-900 text-white px-8 py-4 rounded-full font-medium hover:bg-stone-800 transition-colors">
                Iniciar mi proceso
      ...
      <section id="sobre-mi" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <span className="text-amber-700 font-medium tracking-widest uppercase text-sm mb-4 block">Sobre mí</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-stone-800 tracking-tight">Embajadora del desarrollo personal</h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed">
              ...
              <blockquote className="border-l-4 border-amber-500 pl-6 my-8 py-2">
                <p className="text-xl text-stone-800 font-serif italic mb-2">"Enciende tu luz interior y compartila con los demás, abandonando la ilusión de control."</p>
              ...
              <div className="pt-8 mt-8 border-t border-stone-100 flex flex-col sm:flex-row gap-6 sm:items-center">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <p className="font-bold text-stone-900">Creadora</p>
                    <p className="text-sm text-stone-500">Bienvenida Consciencia</p>
                  </div>
                </div>
                <div className="hidden sm:block w-px h-12 bg-stone-200"></div>
                <a href="#contacto" className="text-amber-700 font-medium hover:text-amber-800 flex items-center gap-2 group">
      ...
      <section id="servicios" className="py-24 bg-stone-900 text-stone-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-amber-500 font-medium tracking-widest uppercase text-sm mb-4 block">Mi Trabajo</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="bg-stone-800/50 p-10 rounded-2xl border border-stone-700/50 hover:border-amber-500/30 transition-colors group flex flex-col">
              <Compass className="w-10 h-10 text-amber-500 mb-6" />
              <h3 className="text-2xl font-bold mb-4">Mentorías 1 a 1</h3>
              ...
              <Link href="/mentorias" className="text-amber-400 font-medium text-sm flex items-center gap-2 w-fit group-hover:text-amber-300 transition-colors">
            ...
            <div className="bg-stone-800/50 p-10 rounded-2xl border border-stone-700/50 hover:border-amber-500/30 transition-colors group flex flex-col">
              ...
              <Link href="/bienestar" className="text-amber-400 font-medium text-sm flex items-center gap-2 w-fit group-hover:text-amber-300 transition-colors">
            ...
            <div className="bg-stone-800/50 p-10 rounded-2xl border border-stone-700/50 hover:border-amber-500/30 transition-colors group flex flex-col">
              ...
              <Link href="/programas" className="text-amber-400 font-medium text-sm flex items-center gap-2 w-fit group-hover:text-amber-300 transition-colors">
      ...
      <section className="py-24 bg-stone-100">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-amber-700 font-medium tracking-widest uppercase text-sm mb-4 block" id="aprender">Programa Estrella</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-stone-800 tracking-tight">Aprender a Aprender</h2>
            ...
            <ul className="space-y-6 mb-10 text-stone-700">
              <li className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-amber-200 flex items-center justify-center shrink-0">1</div>
                <div>
                  <strong className="block text-stone-900 text-lg">9 Talleres Online Grupales</strong>
                  <span>Espacios de aprendizaje vivencial y reflexivo (1 cada dos semanas, 2.5 hs c/u).</span>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-amber-200 flex items-center justify-center shrink-0">2</div>
                <div>
                  <strong className="block text-stone-900 text-lg">5 Rutas de Aprendizaje Individual</strong>
                  <span>Lecturas y prácticas que podés hacer a tu propio ritmo para anclar el conocimiento.</span>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-amber-200 flex items-center justify-center shrink-0">3</div>
                <div>
                  <strong className="block text-stone-900 text-lg">4 Sesiones de Coaching 1 a 1</strong>
            ...
            <div className="p-8 bg-white rounded-2xl border border-stone-200 shadow-sm relative overflow-hidden">
              ...
              <p className="font-bold text-stone-900 text-lg mb-2 flex items-center gap-2">
              ...
              <a href="#contacto" className="inline-flex w-full sm:w-auto items-center justify-center gap-2 bg-stone-900 text-white px-8 py-3.5 rounded-full font-medium hover:bg-stone-800 hover:shadow-lg transition-all group">
                Reservar tu lugar
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
      ...
      <section id="arte" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-amber-500 font-medium tracking-widest uppercase text-sm mb-4 block">Arte y Reflexión</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-stone-800 tracking-tight">El lienzo como espejo del alma.</h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-stone-50 p-8 md:p-12 rounded-2xl border border-stone-100 relative">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <BookOpen className="w-24 h-24 text-stone-800" />
              </div>
              <h3 className="text-2xl font-bold text-stone-900 mb-6 italic font-serif">"Confía que donde estás es donde debés estar."</h3>
              <div className="space-y-4 text-stone-600 leading-relaxed relative z-10">
                ...
                <p className="font-bold text-stone-900 pt-4 border-t border-stone-200 mt-6 block">¿Cuál sería en vos ese cambio urgente si te despojaras por completo de tus miedos hoy?</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-6">
              <a href="https://wa.me/5493572440360?text=Hola%20Erika!%20Estoy%20viendo%20tu%20web%20y%20me%20gustar%C3%ADa%20hacerte%20una%20consulta." target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-4 rounded-xl bg-stone-800/50 hover:bg-stone-800 border border-stone-700/50 transition-colors">
                ...
                <div>
                  <h4 className="font-bold text-white group-hover:text-amber-500 transition-colors">WhatsApp Directo</h4>
          ...
          <div className="bg-stone-800 p-8 rounded-2xl border border-stone-700 shadow-xl">
            <h3 className="text-2xl font-bold mb-6 text-white block border-b border-stone-700 pb-4">Dejame tu mensaje</h3>
            <form className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-stone-400 mb-1" htmlFor="nombre">Nombre completo</label>
                <input type="text" id="nombre" className="w-full bg-stone-900 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 placeholder:text-stone-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all" placeholder="Juan Pérez" />
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-400 mb-1" htmlFor="correo">Correo electrónico</label>
                <input type="email" id="correo" className="w-full bg-stone-900 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 placeholder:text-stone-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all" placeholder="juan@correo.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-400 mb-1" htmlFor="asunto">Asunto de consulta</label>
                <input type="text" id="asunto" className="w-full bg-stone-900 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 placeholder:text-stone-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all" placeholder="Interés en Mentoría" />
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-400 mb-1" htmlFor="mensaje">Mensaje</label>
                <textarea id="mensaje" rows={4} className="w-full bg-stone-900 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 placeholder:text-stone-600 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all resize-none" placeholder="Hola Erika, te escribo porque..."></textarea>
              </div>
              <button type="submit" className="w-full bg-amber-600 text-white font-bold py-4 rounded-lg hover:bg-amber-500 transition-colors mt-2">
      ...
      <div className="fixed bottom-[92px] right-6 z-50">
        ...
        <button
          ...
          className={`w-12 h-12 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-105 ${isFaqOpen
            ...
            : 'bg-white text-stone-800 border border-stone-200 hover:bg-stone-50 hover:shadow-xl'
            }`}
                ...
                {faqs.map((faq, index) => (
                  <div key={index} className="border-b border-stone-100 last:border-0">
                    <button
                      ...
                      className="w-full text-left p-4 flex items-center justify-between gap-4 hover:bg-stone-50 transition-colors rounded-lg"
                    >
                    ...
                    <AnimatePresence>
                      {openQuestionIndex === index && (
                        ...
                        >
                          <p className="p-4 pt-0 text-sm text-stone-600 leading-relaxed bg-stone-50/50">
                            {faq.a}
                          </p>
                        </motion.div>
                      )}
